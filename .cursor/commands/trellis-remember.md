...
Record this session into the Trellis journal. Do **not** archive a task. Mini-trellis does not manage task creation or execution.
...
Do not run `task.py archive`. An active Trellis task is not required.

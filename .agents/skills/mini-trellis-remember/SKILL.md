---
name: mini-trellis-remember
description: "Record this session into the mini-trellis journal. Use when the user asks to remember, persist notes, end the session, or after compact. May also write .trellis/research/<topic>.md."
---

...
|-------|---------|-------------|
| [Mini-Trellis Memory Layer](./mini-memory.md) | Journal, research inbox, spec indexes, and SessionStart — no task workflow | Session start, compact, remember, or promoting research into spec |
